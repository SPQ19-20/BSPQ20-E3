...
.text("CONFIRMED CASES THROUGH TIME");
  ...
  var color = d3.scaleOrdinal()
    ...
    svg2.append("text").attr("x", 30).attr("y", 150).text("Unite Kingdom").style("font-size", "15px").attr("alignment-baseline","middle")
    svg2.append("text").attr("x", 30).attr("y", 180).text("US").style("font-size", "15px").attr("alignment-baseline","middle")
