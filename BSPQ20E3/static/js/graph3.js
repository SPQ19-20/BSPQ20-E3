...
//filter the countries we have chosen (the most infected ones)
  ...
  var color = d3.scaleOrdinal()
    ...
    svg3.append("rect").attr("x", -30).attr("y",height+5).attr("height",20).attr("width",500).style("fill", '#FFF');
    ...
    svg3.append("text").attr("x", 90).attr("y", height+15).text(setdays(date1,days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg3.append("text").attr("x", 190).attr("y", height+15).text(setdays(date1,2*days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg3.append("text").attr("x", 285).attr("y", height+15).text(setdays(date1,3*days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg3.append("text").attr("x", 360).attr("y", height+15).text("now").style("font-size", "10px").attr("alignment-baseline","middle")
