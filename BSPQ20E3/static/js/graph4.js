...
svg5.append("rect").attr("x", -50).attr("y",-50).attr("height",500).attr("width",680).style("fill", '#FFF');
...
//filter the countries we have chosen (the most infected ones)
  ...
  var color = d3.scaleOrdinal()
    ...
    svg5.append("rect").attr("x", -30).attr("y",height+5).attr("height",20).attr("width",680).style("fill", '#FFF');
    ...
    svg5.append("text").attr("x", 130).attr("y", height+15).text(setdays(date1,days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg5.append("text").attr("x", 260).attr("y", height+15).text(setdays(date1,2*days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg5.append("text").attr("x", 385).attr("y", height+15).text(setdays(date1,3*days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg5.append("text").attr("x", 520).attr("y", height+15).text(setdays(date1,4*days)).style("font-size", "10px").attr("alignment-baseline","middle")
    svg5.append("text").attr("x", 600).attr("y", height+15).text("now").style("font-size", "10px").attr("alignment-baseline","middle")
